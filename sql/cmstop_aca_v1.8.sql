...
--
-- Dumping data for table `cmstop_aca`
--
...
(422, 419, 'page', 'page', 'manage,admin,property,sectionlog,publish,edit,visualedit,preview,add,bakup,bakSuggest,recover,exportTemplate,remove,restore,delete,logs,logs_page,copy', '管理'),
...
(1107, 1104, 'mobile', 'setting', 'category,category_page,category_add,category_edit,category_set_headline,category_enable,category_disable,category_delete,category_updown,category_priv,category_priv_add,category_priv_delete', '频道管理'),
...
(1140, 1138, 'mobile', 'video', 'edit,view,quickedit,sethot', '编辑'),
(1141, 1138, 'mobile', 'video', 'view,sethot', '查看'),
...
(1223, 672, 'mobile', 'ad', NULL, '广告'),
(1224, 882, 'cloud', 'changyan', NULL, '搜狐畅言评论 接口'),
(1225, 882, 'cloud', 'issue', NULL, '云服务鉴权'),
(1226, 291, 'contribution', 'index', 'pass', '批量通过'),
(1227, 672, 'mobile', 'live', NULL, '直播'),
(1228, 1104, 'mobile', 'setting', 'live', '直播设置'),
(1229, 1104, 'mobile', 'setting', 'static_page', '静态页面管理'),
(1230, 1104, 'mobile', 'setting', 'style', '风格设置'),
(1231, NULL, 'safe', NULL, NULL, '安全'),
(1232, 1231, 'safe', 'domain', NULL, '域名安全'),
(1233, 1231, 'safe', 'log', NULL, '登陆日志'),
(1234, 1233, 'safe', 'log', 'index,page', '浏览'),
(1235, 1233, 'safe', 'log', 'delete', '删除'),
(1236, 1231, 'safe', 'setting', NULL, '安全'),
(1237, 1231, 'safe', 'trojan', NULL, '木马扫描'),
(1238, 1231, 'safe', 'verify', NULL, '文件校验'),
(1239, NULL, 'sobeyvms', NULL, NULL, '索贝VMS'),
(1240, 173, 'video', 'vms', 'index,view,preview,edit', '使用'),
(1241, NULL, 'wechat', NULL, NULL, '微信'),
(1242, 1241, 'wechat', 'account', NULL, '微信'),
(1243, 1241, 'wechat', 'index', NULL, '微信'),
(1244, 1241, 'wechat', 'material', NULL, '微信'),
(1245, 1241, 'wechat', 'reply', NULL, '微信');
