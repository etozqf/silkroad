...
(function(win) {
    ...
    jeDt.weeks = [ "Sun", "Mon", "Tues", "Wed", "Thur", "Fri", "Sat" ];
    //节日
    ...
    InitDate.prototype = {
        ...
        setHtml:function(opts, self) {
            ...
            var dateymList = !isformat ? '<div class="jedatetopym" style="display: none;">' + '<ul class="ymdropul"></ul><p><span class="jedateymchle">&#8592;</span><span class="jedateymchri">&#8594;</span><span class="jedateymchok">Close</span></p>' + "</div>" :'<ul class="jedaym"></ul>';
            var dateriList = '<ol class="jedaol"></ol><ul class="jedaul"></ul>';
            var bothmsStr = !isformat ? '<ul class="botflex jedatehms"><li><em data-hms="24"></em><i>:</i></li><li><em data-hms="60"></em><i>:</i></li><li><em data-hms="60"></em></li></ul>' + '<div class="botflex jedatebtn"><span class="jedateclear" style="width:31%;">Clear up</span><span class="jedatetodaymonth" style="width:31%;">Today</span><span class="jedateok" style="width:31%;">Confirm</span></div>' :'<div class="botflex jedatebtn"><span class="jedateclear" style="width:31%;">Clear up</span><span class="jedatetodaymonth" style="width:31%;">This month</span><span class="jedateok" style="width:31%;">Confirm</span></div>';
        ...
        getDateStr:function(y, m, d) {
            ...
            jeDt.text(QD(Cell + " .jedateyear")[0], 'Year:' + y).attr(QD(Cell + " .jedateyear")[0], "data-year", y);
            jeDt.text(QD(Cell + " .jedatemonth")[0], 'Month:' + m).attr(QD(Cell + " .jedatemonth")[0], "data-month", m);
            //是否显示节日
