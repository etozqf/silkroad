function WindowLoad()
{
	...
	ndExample1.DateChooser.setIcon('{IMG_URL}templates/{TEMPLATE}/css/images/rl.jpg', 'yearselectex1');
	...
	ndExample2.DateChooser.setIcon('{IMG_URL}templates/{TEMPLATE}/css/images/rl.jpg', 'yearselectex2');
	return true;
}
