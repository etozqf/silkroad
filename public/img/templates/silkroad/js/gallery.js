...
var gallery = function(config) {
    ...
    $('.gal_list_thumb', $(ul)).width(($(list[0]).width() * len)+25);
    ...
    function Go(i, o) {
        ...
        //得到大图的父节点
        a_link=photo.parentNode;

        //得到指定小图下方描述中的href属性值
        var a_desc_href=$(".tit-h4")[i].firstChild.getAttribute("href");
        
        //大图超链接中，添加href属性值        
        a_link.setAttribute("href",a_desc_href);
