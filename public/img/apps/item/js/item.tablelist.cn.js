...
$.fn.tablelist = function(options){
    return this.each(function(){
        ...
        function complete(json){
            ...
            $('.a-page span').html(page_total);
            $('.page').prepend('<span style="width:158px;border:none;"><em style="color:red;border:none;">'+page_total+'</em>&nbsp;pages,&nbsp;<em style="color:red;border:none;">'+json.total+'</em>&nbsp;records</span>');
        }
