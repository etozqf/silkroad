...
(function ($) {
    $.fn.lightBox = function (settings) {
        settings = jQuery.extend({overlayBgColor:'#000', overlayOpacity:0.8, fixedNavigation:false, imageLoading:'images/lightbox-ico-loading.gif', imageBtnPrev:'images/lightbox-btn-prev.gif', imageBtnNext:'images/lightbox-btn-next.gif', imageBtnClose:'images/lightbox-btn-close.gif', imageBlank:'images/lightbox-blank.gif', containerBorderSize:10, containerResizeSpeed:400, txtImage:'图片', txtOf:'/', keyToClose:'c', keyToPrev:'p', keyToNext:'n', imageArray:[], activeImage:0}, settings);
        ...
        function _set_image_to_view() {
            ...
            $('<img />').load(function() {
                var pageSize = ___getPageSize(),
                    width = Math.min(pageSize[2] - 50, this.width),
                    height = Math.min(pageSize[3] - 150, this.height);
                $('#lightbox-image')
                    .attr('src', this.src)
                    .css({
                        'max-width': width,
