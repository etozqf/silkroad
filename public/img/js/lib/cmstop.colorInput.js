 ...
 * @version    $Id: cmstop.colorInput.js 9553 2013-12-31 08:38:58Z dengguanglei $
 */
(function($){
var pane = null;
var doc = $();
...
function createPane(val) {
    ...
    $('<span title="清除" val="blank">E</span>').appendTo(control);
    $('<span title="透明" val="transparent">T</span>').appendTo(control);
