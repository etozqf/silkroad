...
(function(namespace, expando) {
	...
	function EventUtils(proxy) {
		...
		self.remove = function(target, events, func) {
			...
			// Old API supported multiple targets
			// kaze : fixed a bug AT IE8 2012-3-21
			try {
...
(function(tinymce) {
	...
	tinymce.create('tinymce.AddOnManager', {
		...
		requireLangPack : function(n) {
			...
			// kaze : 解决加载undefined/langs/ch.js的问题 2012-3-21
			if (s && s.language && s.language_load !== false && this.urls[n])
	...
	tinymce.create('tinymce.Editor', {
		...
		_addEvents : function() {
			...
			t.onKeyUp.add(function(ed, e) {
				var c = e.keyCode;
				// fixed: ctrl + A was not changed. (by kaze 2012-8-6
				if ((c >= 33 && c <= 36) || (c >= 37 && c <= 40) || c == 13 || c == 45 || c == 46 || c == 8 || c==65 || (tinymce.isMac && (c == 91 || c == 93)) || e.ctrlKey)
					t.nodeChanged();
			});
