...
<tr id="row_{departmentid}">\
	...
	<td class="t_r">\
		<img class="hand" height="16" width="16" src="images/add_1.gif" alt="添加" title="添加" />\
		<img class="hand edit" height="16" width="16" src="images/edit.gif" alt="编辑" title="编辑" />\
		<img class="hand del" height="16" width="16" src="images/delete.gif" alt="删除" title="删除" />\
	</td>\
</tr>';
var acaTreeTemplate = '\
<tr id="acarow_{acaid}">\
