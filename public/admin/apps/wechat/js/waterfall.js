(function($) {
	...
	$.fn.BlocksIt = function(options) {
		...
		var aliasAppend = this.append;
		this.append = function(obj) {
			aliasAppend.apply(this, arguments);
			setPosition(obj, blockarr.length);
			var heightarr = getHeightArr(0, blockarr.length);
			container.height(heightarr[1] + blocksOptions.offsetY);
		};

		var aliasEmpty = this.empty;
		this.empty = function() {
			aliasEmpty.apply(this, arguments);
			this.refresh();
		}

		var aliasPrepend = this.prepend;
		this.prepend = function(obj) {
			aliasPrepend.apply(this, arguments);
			this.refresh();
		}

		this.insertAfter = function(obj, beforeElm) {
			obj.insertAfter(beforeElm);
			this.refresh();
		}
