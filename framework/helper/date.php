...
class date extends object
{
    ...
    public static function this_week($timestamp = false)
    {
        static $result = null;
        if (is_null($result))
        {
            list($year, $month, $day, $day_of_week) = explode(' ', date('Y m d N', TIME));
            $result = mktime(0, 0, 0, $month, $day - ($day_of_week - 1), $year);
        }
        return $timestamp ? $result : date('Y-m-d 00:00:00', $result);
    }
    ...
    public function firstday_of_week()
    {
        ...
        return (new date(mktime(0, 0, 0, $this->month, $this->day - $wday, $this->year)));
    }
	...
	public function starttime_of_month()
    {
        return (new date(mktime(0, 0, 0, $this->month, 1, $this->year)));
    }
    ...
    public function starttime_of_year()
    {
    	return (new date(mktime(0, 0, 0, 1, 1, $this->year)));
    }
    ...
    public function endtime_of_month()
    {
        return (new date(mktime(23, 59, 59, $this->month + 1, 0, $this->year)));
    }
    ...
    public function endtime_of_year()
    {
    	return (new date(mktime(23, 59, 59, 1, 0, $this->year + 1)));
    }
