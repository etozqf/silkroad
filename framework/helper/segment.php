...
class segment
{
    ...
    function add_dict($path, $mode = SCWS_XDICT_XDB)
    {
        return scws_add_dict($this->sh, $path, $mode);
    }

    function add_text_dict($path, $mode = SCWS_XDICT_XDB)
    {
        return $this->add_dict($path, $mode + SCWS_XDICT_TXT);
    }
