...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form mar_l_8">
    ...
    <tr>
        <th width="120">无刷新展示：</th>
        <td><input type="radio" name="setting[refresh]" value="0" class="radio" <?php if ($setting['refresh'] == 0) echo 'checked';?>/> 启用 &nbsp; <input type="radio" name="setting[refresh]" value="1" class="radio" <?php if ($setting['refresh'] == 1) echo 'checked';?>/> 禁用</td>
    </tr>
	<tr>
	    <th>&nbsp;</th>
