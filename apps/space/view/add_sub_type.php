...
<div class="bk_8"></div>
<form name="column_add" id="column_add" method="POST" class="validator" action="?app=space&controller=index&action=check_add_sub_type">
<table border="0" cellspacing="0" cellpadding="0" class="table_form">
	<tbody>
		<tr><th width="80"> 分类名称：</th><td><input type="text" name="name" value="<?=$name?>" size="30"/></td></tr>
		<tr><th>状态：</th><td>
		<select name="status">
		...
		<tr><th>排序：</th><td><input type="text" name="sort" value="0" size="3"/></td></tr>
		<tr>
            <th width="120"></th>
            <td colspan="3">
