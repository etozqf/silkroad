...
class model_space extends model implements SplSubject
{
	...
	public $types   = array(0=>'记者观察',1=>'推荐专家', 2=>'机构研究',3=>'知识产权');
	...
	function __construct()
	{
		...
		$this->_fields = array('spaceid','typeid', 'name', 'author', 'initial', 'alias', 'photo','description','advice', 'userid', 'created', 'createdby', 'modified', 'modifiedby', 'status', 'sort', 'iseditor','posts', 'comments', 'pv', 'tags','sub_type');
	...
	function add($data)
	{
		...
		$data = $this->filter_array($data, array('typeid','userid','name','author','initial','alias','photo','description','advice','status','sort','iseditor','tags','sub_type'));
