...
<title><?=$SETTING['sitename']?>_网站后台登录 Powered By CmsTop</title>
...
<div id="logindiv">
  <ul>
    ...
    <li>验证码：
      <label>
        <input type="text" name="seccode" id="seccode" size="4" maxlength="4" style="ime-mode:disabled;width:65px;"/> <img id="seccode_image" src="?app=system&controller=seccode&action=image" width="52" height="24" style="cursor:pointer;" alt="验证码,看不清楚?请点击刷新验证码" align="absmiddle"/>
      </label>
    </li>
    <li>
      <label>
...
var rememberusername = $.cookie(COOKIE_PRE+'admin_rememberusername'),
