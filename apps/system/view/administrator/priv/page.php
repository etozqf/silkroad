...
<a href="?app=system&controller=administrator&action=priv&userid=<?=$userid?>&type=category">栏目权限</a>
<a class="s_5" href="?app=system&controller=administrator&action=priv&userid=<?=$userid?>&type=page">页面权限</a>
    <p class="f_r mar_r_8">
...
treeOptions = {
	...
	baseUrl:'?app=system&controller=administrator&action=priv&userid=<?=$userid?>&type=page',
