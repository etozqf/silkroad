...
<a  class="s_5" href="?app=system&controller=administrator&action=priv&userid=<?=$userid?>&type=action">操作权限</a>
...
treeOptions = {
	...
	collapsed:1,
	baseUrl:'?app=system&controller=role&action=acatree&baseroleid=<?=$roleid?>',
