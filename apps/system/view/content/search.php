...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form"> 
  <tr>
    <th>ID：</th>
    <td><input type="text" name="contentid" value="<?=$contentid?>" size="10" placeholder="ID"/></td>
  </tr>
  <tr>
    <th width="60">栏目：</th>
    <td>
        <?=element::category('catid', 'catids', $catid, 1, null, '请选择', true, true, array('checkparents'=>true))?>
	</td>
  </tr>
  <tr>
    <th>模型：</th>
