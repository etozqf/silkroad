  <div id="created_x" class="th_pop" style="display:none;width:160px">
     <div>
        <a href="javascript: tableApp.load('created_min=0');">全部</a> |
  ...
  <div class="table_foot">
    ...
    <p class="f_l">
      ...
      <?php endif;?>
      <?php if(priv::button('pass', $modelid)):?>
      <input type="button" name="pass" onclick="content.pass();" value="通过" class="button_style_1" title="将选择的内容通过审核"/>
      <?php endif;?>
      ...
      <?php endif;?>
      <?php if(priv::button('reject', $modelid)):?>
      <input type="button" name="reject" onclick="content.reject();" value="退稿" class="button_style_1" title="退稿所选择的内容"/>
      <?php endif;?>
    </p>
  </div>
