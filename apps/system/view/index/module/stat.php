...
$r = $db->get("select count(*) as comments from #table_comment where 1");
$comments = $r['comments'];

$r = $db->get("select count(*) as comments from #table_comment where status=1");
$comments_check = $r['comments'];

$r = $db->get("select count(*) as comments from #table_comment where created>=$today");
