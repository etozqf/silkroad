...
<table width="98%" cellpadding="0" cellspacing="0" id="item_list" class="tablesorter table_list mar_l_8">
	<thead><tr>      
		...
		<th width="18%">操作说明</th>
        <th>操作URL</th>
		<th width="10%" class="ajaxer"><div name="time">操作时间</div></th>
		<th width="15%" class="ajaxer"><div name="ip">操作IP</div></th>
		<th width="6%" class="ajaxer"><div name="dur">响应</div></th>
	</tr></thead>
...
var row_template = '<tr id="row_{logid}">';
    ...
    row_template +='	<td class="t_l">{aca}</td>';
	...
	row_template +='	<td class="t_c">{dur}s</td>';
	row_template +='</tr>';
