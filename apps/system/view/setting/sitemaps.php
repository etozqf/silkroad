...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form mar_l_8">
	...
	<tr>
		<th>包含页面：</th>
		<td valign="middle">
			<table id="page_tree" width="93%" class="table_list mar_l_8" cellpadding="0" cellspacing="0"><tbody></tbody></table>
		</td>
	</tr>
	<tr>
		<th>输出条数：</th>
...
$(function(){
    ...
    $("input[name='setting\[modelid\]\[\]'][value='3']").attr('disabled',true);

    // page tree
    var page = ',<?php echo $setting['page'];?>,';
    pagePrivTemplate = '\
	<tr id="pagepriv_{pageid}">\
		<td class="t_l">\
			<label><input type="checkbox" class="checkbox_style" name="setting[page][]" value="{pageid}" /> {name}</label>\
		</td>\
	</tr>';
    pageTreeOptions = {
		idField:'pageid',
		...
		collapsed:1,
		baseUrl:'?app=system&controller=sitemaps&action=pagetree',
