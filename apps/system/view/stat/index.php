<?php $this->display('header', 'system'); ?>
    ...
    <div class="bg_1" id="tree_in" style="margin-top:10px;width:860px">
        <div class="w_160 box_6 mar_r_8 f_l"
             style="position:relative;width:155px;height:740px;background: #F9FCFD;border-top:1px solid #00C2E6">
        ...
        <div class="f_l" style="padding-left:10px;width:680px">
            <div class="bk_10"></div>
            <div style="text-align:right;margin-bottom:5px;width:100%">统计时间：<span id="last_stat_time"></span>&nbsp;&nbsp;<span><a
                        href="javascript:;" onclick="load(1)">重新统计</a></span></div>
            <div id="stat">
                <div id="proids" style="margin-right:0px">
                    <dl class="proids" id="year">
                        <dt>年份：</dt>
                        <dd>
                            <a href="0">全部</a>
                            <?php
            ...
            <div id="data" style="width:99%;;margin-left:1%">
                <div
                    style="background-color: #FFFDD7;border: 1px solid #FDBD77;height:20px;padding:10px 0px 10px 5px;margin:5px 0px;">
                    统计概况：发稿量(<span id="total_posts" style="color:red"></span>)&nbsp;&nbsp;评论量(<span id="total_comments"
                                                                                                    style="color:red"></span>)&nbsp;&nbsp;浏览量(<span
                        id="total_pv" style="color:red"></span>)
                </div>
