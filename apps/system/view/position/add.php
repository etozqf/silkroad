<div class="bk_8"></div>
<form name="<?=$app?>_<?=$controller?>_<?=$action?>" id="<?=$app?>_<?=$controller?>_<?=$action?>" method="post" class="validator" action="?app=<?=$app?>&controller=<?=$controller?>&action=add">
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form">
	<tr>
		<th width="80"><span class="c_red">*</span> 园区名称：</th>
		<td><input name="name" type="text" value="<?=$name?>" size="16" maxlength="255"  /></td>
	</tr>
	...
	<tr>
		...
		<td><input name="province" type="text" value="<?=$province?>" size="16" maxlength="255"  /><span style="color:#ccc">(例如河北省,北京市,新疆维吾尔自治区)(或韩国,日本)</span></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			?>
				<option value="<?php echo $val['cateid'];?>"><?php echo $val['value'];?></option>
