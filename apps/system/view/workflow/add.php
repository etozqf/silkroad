<div class="bk_8"></div>
<form name="system_workflow_add" id="system_workflow_add" method="POST" action="?app=system&controller=workflow&action=add">
...
function step_add()
{
	i++;
	steps++;
	var role = role_select.replace('{$i}', i).replace('{$i}', i);
