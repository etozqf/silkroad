...
var App = function(){
    ...
    init_row_event = function(id, tr){
        var name = tr.find('a.role');
        id > 2 && name.click(function(){
            a.edit(id, tr);
        });
        var edit = tr.find('>td>img.edit');
        id <=1 ? edit.hide() : edit.click(function(){
            a.edit(id, tr);
        });
        var del = tr.find('>td>img.delete');
        id <= 2 ? del.hide() : del.click(function(){
            a.del(id);
        });
    },
    rowTemplate = '\
    ...
    a = {
        ...
        "edit":function(id, tr){
            ...
            ct.form('编辑角色', url, 420, 'auto', function(json){
            	...
            	var tree = new ct.treeTable(table, $.extend({rowsPrepared:function(){
        ...
        "add":function(){
            ct.form('添加角色',addUrl, 420, 'auto',function(json){
            	if (json.state)
            	{
    	            a.table.reload();
    	            return true;
    	...
    	"clone":function(id) {
    		var url = addUrl+'&roleid='+id;
    		ct.form('添加角色',url, 420, 'auto',function(json){
            	if (json.state)
            	{
        ...
        "export":function(id){
            //ct.assoc.open('?app=system&controller=role&action=export&id='+id, 'newtab');
            _jump('?app=system&controller=role&action=export&id='+id);
        }
    };
    return a;
}();
...
<ul id="right_menu" class="contextMenu">
   ...
   <li class="clone"><a href="#App.clone">复制</a></li>
   <li class="export"><a href="#App.export">查看</a></li>
</ul>
<script type="text/javascript">
