...
define('XAUTH_SITE_LOGIN_URL',		'http://app.db.silkroad.news.cn/?app=member&controller=index&action=login');
/// 你的网站注册地址 Xweibo　会自动添加　XAUTH_SITE_CALLBACK_NAME　参数，
define('XAUTH_SITE_REG_URL',		'http://app.db.silkroad.news.cn/?app=member&controller=index&action=register');
...
define('XAUTH_TK_DATA_ENCRIPT_KEY',	'zxc1vbn2m3');
/// TOKEN  明文内容所用的字符集
...
define('XAUTH_CK_DOMAIN',	'.db.silkroad.news.cn');
