...
class model_admin_content extends model implements SplSubject
{
	...
	function __construct()
	{
		...
		$this->_fields = array('contentid', 'catid', 'modelid', 'title', 'subtitle', 'color', 'thumb', 'tags', 'sourceid', 'source_title', 'source_link', 'url', 'weight', 'status', 'status_old', 'created', 'createdby', 'published', 'publishedby', 'unpublished', 'unpublishedby', 'modified', 'modifiedby', 'checked', 'checkedby', 'locked', 'lockedby', 'noted', 'notedby', 'note', 'workflow_step', 'workflow_roleid', 'iscontribute', 'allowcomment', 'comments', 'pv', 'spaceid', 'related','score', 'topicid', 'tweeted', 'ischarge','yuanquid','markid');
    ...
    //丝路网项目新加 end
		...
		$data = $this->filter_array($this->data, array('catid', 'modelid', 'title', 'subtitle', 'color', 'thumb', 'tags', 'sourceid', 'source_title', 'source_link', 'url','weight', 'created', 'createdby','published', 'publishedby', 'unpublished', 'unpublishedby', 'status', 'workflow_step', 'workflow_roleid', 'iscontribute', 'allowcomment', 'related','spaceid', 'ischarge','yuanquid','markid'));
    ...
    //丝路网项目新加 end
		...
		empty($data['thumb']) && $data['thumb'] = null; 
		$data = $this->filter_array($this->data, array('catid', 'modelid', 'title', 'subtitle', 'color', 'thumb', 'tags', 'sourceid', 'source_title', 'source_link', 'url', 'weight', 'published','publishedy','unpublished', 'unpublishedby', 'modified', 'modifiedby', 'status', 'status_old', 'allowcomment', 'related','spaceid','ischarge','yuanquid','markid'));
	...
	function remove($contentid)
	{
		...
		if ($result)
		{
			...
			intface($data['publishedby'],0,$data['modelid'],table('category',$data['catid'],'name'),$contentid,'del');
			//丝路网新增加接口调用代码 end
		}
		return $result;
	}
