<form method="POST" action="?app=page&controller=section&action=property">
    <table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form">
        ...
        <tr>
            <th><span class="c_red">*</span> RPC 源：</th>
            <td><input type="text" name="url" style="width:345px;" value="<?=$section['url']?>" /></td>
        </tr>
        <tr>
            <th><span class="c_red">*</span> 调用接口：</th>
            <td><input type="text" name="method" size="20" value="<?=$section['method']?>" /></td>
        </tr>
        <tr>
            <th>参数：</th>
            <td><input type="text" name="args" style="width:195px;" value="<?=$section['args']?>" /> 多个参数以逗号“,”隔开</td>
        </tr>
        <tr>
