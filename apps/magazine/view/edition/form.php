...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form">
	...
	<tr>
		<th> 简介：</th>
		<td><textarea name="description" cols="50"><?=$description?></textarea> 
		</td>
	</tr>
	...
	<tr>
		<th><span class="c_red">*</span> 是否收费：</th>
		<td>
			是：<input type="radio" name="ispay" <? if($ispay == 1) echo 'checked';?> value="1" />&nbsp;&nbsp;&nbsp;&nbsp;
			否：<input type="radio" name="ispay" <? if($ispay != 1) echo 'checked';?> value="0" />
		</td>
	</tr>
	<tr>
		<th width="100"> 价格：</th>
		<td>
			<input type="text" name="premium" id="premium" value="<?=$premium?>" size="20"/>
		</td>
	</tr>
</table>
</form>
