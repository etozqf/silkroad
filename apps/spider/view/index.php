...
<div class="box_10 mar_l_8 layout" style="width:950px;height:500px;" id="box">
	...
	<div class="f_l" style="width:300px;" id="rightBox">
		<h3 class="navi">
			<span>已选择(<em>0</em>)</span>
			<a style="float:right;" onclick="App.clearTask()" href="javascript:;">清空</a>
		</h3>
		...
		<div class="btn_area ctrl_area">
            <select name="status" id="status">
                ...
                <option value="1"<?php if ($memstatus == 1): ?> selected="selected"<?php endif; ?>>草稿</option>
                <option value="3"<?php if ($memstatus == 3): ?> selected="selected"<?php endif; ?>>待审</option>
                <option value="6"<?php if ($memstatus == 6): ?> selected="selected"<?php endif; ?>>已发</option>
            </select>
            <button type="button" class="button_style_1" onclick="App.run()" style="float:right;">采集</button>
