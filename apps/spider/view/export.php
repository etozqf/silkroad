<pack>
	<?php foreach ($rules as $rule):?><rule>
		...
		<list_rule>
			...
			<listNextPageStart><![CDATA[<?=$rule['list_rule']['listNextPageStart']?>]]></listNextPageStart>
			<listNextPageEnd><![CDATA[<?=$rule['list_rule']['listNextPageEnd']?>]]></listNextPageEnd>
		...
		<content_rule>
			...
			<nextPageStart><![CDATA[<?=$rule['content_rule']['nextPageStart']?>]]></nextPageStart>
			<nextPageEnd><![CDATA[<?=$rule['content_rule']['nextPageEnd']?>]]></nextPageEnd>
