<?php
class LoginEngine_tencent_weibo
{
	public $data;
	private $access_token_url = 'https://open.t.qq.com/cgi-bin/oauth2/access_token';
	private $api_url = 'https://open.t.qq.com/api/';
	private $identity = 'tencent_weibo';
	...
	public function post($topic, $context, $access_token, $auth_key, $params)
	{
		...
		$query = $this->oauth2->request('post', $this->api_url.'t/add', array(
			'format' => 'json',
			'content' => $text,
			'clientip' => IP,
			'jing' => '',
