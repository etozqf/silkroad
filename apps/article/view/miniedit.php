...
<body onload="self.focus()">
	<form name="article_add" id="article_add" method="POST" action="?app=<?=$app?>&controller=<?=$app?>&action=edit">
		<div class="mini-main">
			...
			<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form" >
                ...
                <tr id="source_panel">
                    <th>来源链接：</th>
                    <td class="c_077ac7">
                        <input id="source_link" type="text" name="source_link" value="<?=$source_link?>" class="source-link-input" />
                        &nbsp;&nbsp;&nbsp;&nbsp;
...
$(function() {
    ...
    $("div.cs_sb").find('input').keyup(function(){
        catid.val() && field.getbycid(<?=$contentid?>, catid.val());
    });
