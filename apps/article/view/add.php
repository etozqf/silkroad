	...
	<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form" >
        ...
        <tr>
            ...
            <td>
                ...
                <script type="text/javascript">$(function() { window.editorInput = suggest($("#editor"), {width:200,limit:100,delimiter:",",url:"",paramVal:"editor",paramTxt:"editor",anytext:"3"});  $('#editor').next().find('.listAllBtn').remove()});</script>
            </td>
        </tr>
        <tr>
            <th>来源：</th>
...
<script src="apps/article/js/o2h.js" type="text/javascript" ></script>
<?php
