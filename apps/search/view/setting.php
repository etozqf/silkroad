...
<div class="suggest w_650 mar_l_8">
	...
	<p>官方（英文）：<a href="http://www.sphinxsearch.com/" target="_blank">http://www.sphinxsearch.com/</a></p>
	<p>官方（中文）：<a href="http://www.coreseek.cn/" target="_blank">http://www.coreseek.cn/</a> </p>
</div>
<div class="bk_10"></div>
...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form mar_l_8">
	...
	<tr>
		<th>开启服务：</th>
		<td><input type="checkbox"  name="setting[open]" id="open" value="1" <?php if($setting['open']){?> checked="checked" <?php }?>/></td>
	</tr>
	<tr>
	...
	<tr>
		<th>默认排序：</th>
		<td>
		<label><input class="radio radio_style"  type="radio" name="setting[order]" value="segments" <?php if($setting['order'] == 'segments' || empty($setting['order'])){?> checked="checked"<?php }?> /> 时间段 </label>
		<label><input class="radio radio_style"  type="radio" name="setting[order]" value="rel" <?php if($setting['order'] == 'rel'){?> checked="checked"<?php }?> /> 相关度 </label>
		<label><input class="radio radio_style"  type="radio" name="setting[order]" value="time" <?php if($setting['order'] == 'time'){?> checked="checked"<?php }?> /> 时间 </label>
		</td>
	</tr>
	<tr>
		<th>主索引名称：</th>
