...
{	
	function __construct()
	{
		...
		$this->_fields = array('guestid', 'contentid', 'name','color','initial', 'photo', 'aid', 'resume','url', 'sort');
	...
	function add($data)
	{
		...
		$data = $this->filter_array($data, array('contentid', 'name', 'color', 'initial', 'photo', 'aid', 'resume', 'url', 'sort'));console($data);
	...
	function edit($guestid, $data)
	{
		...
		$data = $this->filter_array($data, array('name', 'color', 'initial', 'photo', 'aid', 'resume', 'url', 'sort'));
