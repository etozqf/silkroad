...
?>
      <input type="button" name="pass" onclick="interview.pass();" value="通过" class="button_style_1"/>
<?php 
}
...
if (priv::aca('interview', 'interview', 'pass')){
?>
    <li class="pass"><a href="#interview.pass">通过</a></li>
<?php 
}
if (priv::aca('interview', 'interview', 'reject')){
?>
...
<?php if ($workflowid && $_roleid < 3){?>
	                 	<td class="t_c">{workflow_rolename}</td>\
<?php }?>
