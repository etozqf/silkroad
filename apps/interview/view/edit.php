...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form mar_l_8">
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="mode" value="text" <?php if($mode == 'text') echo 'checked="checked"';?> onclick="$('#mode_text').show();$('#mode_video').hide();$('#mode_live').hide();"/> 图文
            <input type="radio" name="mode" value="video" <?php if($mode == 'video') echo 'checked="checked"';?> onclick="$('#mode_text').hide();$('#mode_video').show();$('#mode_live').hide();"/> 视频
            <input type="radio" name="mode" value="live" <?php if($mode == 'live') echo 'checked="checked"';?> onclick="$('#mode_text').hide();$('#mode_video').hide();$('#mode_live').show();"/> 直播
        </td>
    </tr>
    <tr id="mode_text">
