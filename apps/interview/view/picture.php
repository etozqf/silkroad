<?php 
$picture = isset($picture) ? $picture : intval($_GET['contentid']);
	...
	<div id="pictures">
	    <ul class="inline w_141">
		 <?php foreach ($pictures as $pic) { ?>
		     <li style="margin:8px"><a href="<?=$pic['url']?>" target="_blank"><img src="<?=thumb($pic['image'], 115, 90)?>" height="90" alt="<?=$pic['note']?>"/></a></li>
		 <?php } ?>	
	    </ul>
	</div>