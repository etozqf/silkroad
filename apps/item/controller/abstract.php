...
abstract class item_controller_abstract extends controller
{
	protected $app, $cache, $json, $template, $view, $config, $setting, $system, $_userid, $_username, $_groupid, $_roleid, $_departmentid,$itemfields;
    ...
    function __construct($app)
    {
		...
		$this->itemfields = app_config('item','item_fields');
		if ($app->client === 'admin')
		{
			...
			$this->view->assign('itemfields', $this->itemfields);
		...
		$this->template->assign('itemfields', $this->itemfields);
