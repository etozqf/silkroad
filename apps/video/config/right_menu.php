...
return array(
	...
	array('class' => 'code', 'text' => '调用代码', 'handler' => 'video.code'),

	array('class' => 'remove', 'text' => '删除', 'status' => '!0'),
	array('class' => 'del', 'text' => '删除', 'status' => '0'),
	array('class' => 'restore', 'text' => '还原', 'status' => '0'),
    array('class' => 'createhtml', 'aca' => 'video/html/show', 'text' => '生成', 'status' => '6'),
    ...
    array('class' => 'pushToMobile', 'aca' => 'mobile/video/add', 'text' => '推至移动端', 'status' => '6'),
