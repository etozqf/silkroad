...
<style type="text/css">
    ...
    td div.icon {background: url(<?php echo IMG_URL?>js/lib/dropdown/bg.gif) no-repeat scroll 0 -50px transparent;	margin-right: 8px;	width: 16px;height: 20px;float: left; cursor: pointer;}
    td div.video {background-position: 0 -123px;}
</style>
...
<div class="tag_1" style="margin-bottom:0;">
    ...
    <div class="f_r" style="width:280px">
        <span>最大允许上传 <span id="maxSize" style="color:red;">0MB</span></span>
        <span id="up" class="button">上传视频</span>
        <button type="button" class="button_style_1" onclick="vms.batImport();">批量导入</button>
    </div>
</div>
    ...
    <div class="f_l search_icon" style="width:470px;">
        <form id="search_f" onsubmit="return false;">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td width="160"><input type="text" size="12" name="keywords" class="search_input_text" style="width:145px" value="<?=$keywords?>"  placeholder="视频名称" /></td>
