...
return array(
	...
	array('class' => 'viewsign', 'text' => '管理报名者', 'status' => '6', 'handler' => 'activity.viewsign'),
    ...
    array('class' => 'createhtml', 'aca' => 'activity/html/show', 'text' => '生成', 'status' => '6'),
    ...
    array('class' => 'pushToMobile', 'aca' => 'mobile/activity/add', 'text' => '推至移动端', 'status' => '6'),
