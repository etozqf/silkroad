<div class="field-type-options">
    ...
    <div class="options-row">
        ...
        <div>
            ...
            <span class="c_gray" title="当前系统设置中的值为 <?=setting('system', 'attachexts')?>">为空则取 <a href="javascript:;" onclick="ct.assoc.open('?app=system&controller=setting&action=attachment', 'newtab');">系统设置</a> 中的值</span>
        </div>
    </div>
</div>