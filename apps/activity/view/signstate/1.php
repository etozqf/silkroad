...
<div style="margin-left:100px;">
    ...
    <div class="table_foot">
        ...
        <p class="f_l">
            <input type="button" name="remove" onClick="sign.del();" value="删除" class="button_style_1"/><input type="button" name="unpass" onClick="sign.unpass();" value="还原" class="button_style_1"/>
        </p>
    </div>
...
<script type="text/javascript">
    var row_template = '<tr id="row_{signid}">'+
        ...
        '<td class="t_c"><img src="images/view.gif" alt="访问" width="16" height="16" class="hand view" /> &nbsp;<img src="images/edit.gif" alt="编辑" width="16" height="16" class="hand edit"/> &nbsp;<img src="images/delete.gif" title="删除" width="16" height="16" class="hand delete" /></td>'+
    '</tr>';
</script>