...
class model_member extends model implements SplSubject
{
	...
	function __construct()
	{
		...
		$this->_fields = array('userid', 'username', 'password', 'email', 'groupid', 'avatar', 'regip', 'regtime', 'lastloginip', 'lastlogintime', 'logintimes', 'posts', 'comments', 'pv', 'credits','salt', 'status','site_type','online_code', 'isfree', 'thirdtype', 'thirdid', 'thirdtoken', 'thirdlastlogin');
