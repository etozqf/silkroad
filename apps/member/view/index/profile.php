...
<div class="tag_1">
	<ul class="tag_list">
		<li class="s_3"><a href="?app=member&controller=index&action=profile&userid=<?=$member['userid']?>">用户资料</a></li>
		<li><a href="?app=member&controller=index&action=readmanage&userid=<?=$member['userid']?>">阅读管理</a></li>
...
<div class="tag_list_1 pad_8 layout mar_l_8" id="bytime_list">
	...
	<a href="javascript:tablePost.load('published_min=<?=date('Y-m-d', date::this_week(true))?>');">本周</a>
	<a href="javascript:tablePost.load('published_min=<?=date('Y-m-01', strtotime('this month'))?>');">本月</a>
	<div class="clear"></div>
</div>
<div class="bk_8"></div>
