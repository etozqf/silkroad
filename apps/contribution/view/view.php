...
<div>
	...
	<div class="f_l box_6" style="border: 1px solid #9AC4DC;">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_form">
			...
			<tr><th>投稿人：</th><td><a href="?app=member&controller=index&action=profile&userid=<?=$createdby?>" target="_blank"><?=$creator?></a> &nbsp;</td></tr>
			<tr><th>邮箱：</th><td><?=$email?></td></tr>
			<tr><th>来源：</th><td><?=$sourcename?></td></tr>
			<tr><th>来源地址：</th><td><?=$sourceurl?></td></tr>
