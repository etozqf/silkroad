...
var manage_td = '<img src="images/delete.gif" alt="删除" width="16" height="16" class="manage" onclick="contribution.remove(\'{contributionid}\');"/>';
var row_template  = '<tr id="row_{contributionid}" right_menu_id="right_menu_{status}">';
	...
	row_template += '	<td class="t_c"><a href="javascript:;" data-view="{annotation}">查看</a></td>'
	row_template += '	<td class="t_c">{rejected}</td>';
	row_template += '</tr>';
</script>