...
<div class="table_foot">
	...
	<p class="f_l">
		<input type="button" name="del" onclick="contribution.del();" value="彻底删除" class="button_style_1"/>
		<input type="button" name="clear" onclick="contribution.clear();" value="清空回收站" class="button_style_1"/>
		<input type="button" name="refresh" onclick="tableApp.load();" value="刷新" class="button_style_1"/>
	</p>
</div>

<script type="text/javascript">
var manage_td = '<img src="images/delete.gif" alt="删除" width="16" height="16" class="manage" onclick="contribution.del(\'{contributionid}\');"/>';
