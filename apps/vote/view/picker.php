...
<link rel="stylesheet" href="apps/vote/css/picker.css" />
...
<script type="text/javascript" src="apps/vote/js/picker.js"></script>
<script type="text/javascript">VotePicker.init(<?=$multiple?>)</script>