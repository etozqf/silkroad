	...
	<tr>
		...
		<td>
			<table width="140" border="0" cellpadding="4" cellspacing="0" id="innerTable">
				...
				<tr>
				  <td><input type="checkbox" id="mobile"name="setting[option][mobile]" value="1" <?php if ($setting['option']['mobile']) echo 'checked';?> class="checkbox" />
					<label for="mobile">手机</label></td>
				  <td><input type="checkbox"id="ismobile" name="setting[option][ismobile]" values="1" <?php if ($setting['option']['ismobile']) echo 'checked';?> />
					<label for="ismobile">必填</label></td>
				</tr>
				<tr>
...
$(function(){
	...
	$("#mobile").click(function(){
		if($("#ismobile").attr("checked")==true) {
			$("#ismobile").attr("checked",false);
		}
	});
	$("#ismobile").click(function(){
		if($("#mobile").attr("checked")!==true) {
			$("#ismobile,#telephone").attr("checked",true);
		}
	});
