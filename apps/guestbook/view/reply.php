...
<table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form">
	...
	<tr>
		<th></th>
		<td>手机 ：<span class="c_gray"><?php echo $data['mobile'];?></span></td>
	<tr>
	<?php } ?>
	<?php if($data['telephone']){ ?>
	<tr>
		<th></th>
		<td>电话 ：<span class="c_gray"><?php echo $data['telephone'];?></span></td>
	<tr>
	<?php } ?>
	<?php if($data['qq']){ ?>
	<tr>
	...
	<tr><th>回复:</th>
		<td align="center"><br/>
		<textarea name="reply" id="textarea" cols="40" rows="9"><?php echo  $data['reply'] ? $data['reply'] : '';?></textarea>
		</td>
	</tr>
</table>
</form>
