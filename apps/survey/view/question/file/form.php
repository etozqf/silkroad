...
<dd><?=$description?></dd>
<dd><input type="text" readonly name="question[<?=$questionid?>]" value="" style="width:250px"/><input type="button" class="button_style_1 mar_l_8" style="vertical-align:top;" value="上传" /></dd>
</dl>