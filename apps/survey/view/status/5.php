  ...
  <table>
	...
	<div id="starttime_x" class="th_pop" style="display:none;width:150px">
		<div>
			...
			<a href="javascript: tableApp.load('starttime_min=<?=date('Y-m-d', date::this_week(true))?>');">本周</a> |
	...
	<div id="endtime_x" class="th_pop" style="display:none;width:150px">
		<div>
			...
			<a href="javascript: tableApp.load('endtime_min=<?=date('Y-m-d', date::this_week(true))?>');">本周</a> |
