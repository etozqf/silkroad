<div class="bk_8"></div>
<form name="content_slider" method="POST" action="?app=mobile&controller=content&action=slider_edit">
    <input type="hidden" name="catid" value="<?=$catid?>" />
    <input type="hidden" name="contentid" value="<?=$contentid?>" />
    <table width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form">
        <tr>
            <th width="60"><span class="c_red">*</span> 标题：</th>
            <td><input type="text" name="title" value="<?=htmlspecialchars($slider['title'])?>" size="40" /></td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <?=element::image('thumb', $slider['thumb'], 20, 1, $attr)?>
            </td>
        </tr>
    </table>
</form>
