...
<table id="style_1" width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form">
	...
	<tr>
		...
		<td><input type="text" name="setting[fieldid]" value="<?=$setting['fieldid']?>" size="40"/></td>
	</tr>
	<tr>
		<th> 文本框显示长度：</th>
		<td><input type="text" size="30" name="setting[inputsize]" value="<?=$setting['inputsize']?>" /></td>
	</tr>
	<tr>
		<th> 允许上传文件类型：</th>
		<td><input type="text" size="30" name="setting[uploadtype]" value="<?=$setting['uploadtype']?>"/>（*全部）</td>
	</tr>
</table>
</form>