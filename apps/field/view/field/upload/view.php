...
<dd>
<input type="text" id="field[<?=$setting['fieldid']?>]" name="field[<?=$setting['var']?>]" style="width:<?=$setting['inputsize']?>px"/>
<img src="images/multiup.gif" style="vertical-align:middle;"/>
</dd>
</dl>