...
<table id="style_1" width="98%" border="0" cellspacing="0" cellpadding="0" class="table_form">
	...
	<tr>
		<th> 内容最大长度：</th>
		<td><input type="text" size="30" name="setting[maxnum]" value="<?=$setting['maxnum']?>" /></td>
	</tr>
	<tr>
		<th> 表单显示长度：</th>
	...
	<tr>
		<th> 默认值：</th>
		<td><input type="text" size="30" name="setting[defaultvalue]" value="<?=$setting['defaultvalue']?>" /></td>
	</tr>
</table>
</form>